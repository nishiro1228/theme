      ...
      <form class="sub-contact__form form" action="">
        ...
        <div class="sub-contact__form-privacy">
          <label>
            ...
            <span><a href="privacy-policy.html">個人情報の取り扱い</a>について同意のうえ送信します。</span>
          </label>
        </div>
        <div class="sub-contact__button">
          <a href="contact3.html" class="commom-button commom-button--send">Send<span
              class="arrow arrow--send"></span></a>
        </div>
      </form>
    </div>
  </div>
