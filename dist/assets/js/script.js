...
jQuery(function ($) {
  ...
  $(document).ready(function () {
    // タブのボタンとコンテンツを取得
    var $tabButtons = $(".js-information-tab-menu");
    var $tabContents = $(".js-information-tab-content");
    ...
    var activateTab = function activateTab(tabName) {
      ...
      var $targetButton = $tabButtons.filter(function (_, btn) {
        return $("#".concat(tabName)).is($tabContents.eq($tabButtons.index(btn)));
      });
      var $targetContent = $("#".concat(tabName));
